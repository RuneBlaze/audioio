torchffmpeg.prototype
====================

``torchffmpeg.prototype`` provides prototype features;
...
The modules under ``torchffmpeg.prototype`` must be
imported explicitly, e.g.

.. code-block:: python

   import torchffmpeg.prototype.models
