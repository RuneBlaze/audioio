...
.. toctree::
   ...
   torchffmpeg <https://pytorch.org/audio>
...
.. customcarditem::
   ...
   :card_description: Learn how to query/load audio files and save waveform tensors to files, using <code>torchffmpeg.info</code>, <code>torchffmpeg.load</code> and <code>torchffmpeg.save</code> functions.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/audio_io_tutorial.png
   :link: tutorials/audio_io_tutorial.html
   :tags: I/O

.. customcarditem::
   :header: Streaming media decoding with StreamReader
   :card_description: Learn how to load audio/video to Tensors using <code>torchffmpeg.io.StreamReader</code> class.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/streamreader_basic_tutorial.png
...
.. customcarditem::
   ...
   :card_description: Learn how to load media from hardware devices, generate synthetic audio/video, and apply filters to them with <code>torchffmpeg.io.StreamReader</code>.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/streamreader_advanced_tutorial.gif
   :link: tutorials/streamreader_advanced_tutorial.html
   :tags: I/O,StreamReader

.. customcarditem::
   :header: Streaming media encoding with StreamWriter
   :card_description: Learn how to save audio/video with <code>torchffmpeg.io.StreamWriter</code>.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/streamwriter_basic_tutorial.gif
   :link: tutorials/streamwriter_basic_tutorial.html
   :tags: I/O,StreamWriter

.. customcarditem::
   :header: Playing media with StreamWriter
   :card_description: Learn how to play audio/video with <code>torchffmpeg.io.StreamWriter</code>.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/streamwriter_advanced.gif
...
.. customcarditem::
   ...
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/hw_acceleration_tutorial.png
...
.. customcarditem::
   ...
   :card_description: Learn how to resample audio tensor with <code>torchffmpeg.functional.resample</code> and <code>torchffmpeg.transforms.Resample</code>.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/audio_resampling_tutorial.png
   :link: tutorials/audio_resampling_tutorial.html
   :tags: Preprocessing

.. customcarditem::
   :header: Audio data augmentation
   :card_description: Learn how to use <code>torchffmpeg.functional</code> and <code>torchffmpeg.transforms</code> modules to perform data augmentation.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/audio_data_augmentation_tutorial.png
   :link: tutorials/audio_data_augmentation_tutorial.html
   :tags: Preprocessing

.. customcarditem::
   :header: Audio feature extraction
   :card_description: Learn how to use <code>torchffmpeg.functional</code> and <code>torchffmpeg.transforms</code> modules to extract features from waveform.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/audio_feature_extractions_tutorial.png
   :link: tutorials/audio_feature_extractions_tutorial.html
   :tags: Preprocessing

.. customcarditem::
   :header: Audio feature augmentation
   :card_description: Learn how to use <code>torchffmpeg.functional</code> and <code>torchffmpeg.transforms</code> modules to perform feature augmentation.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/audio_feature_augmentation_tutorial.png
...
.. customcarditem::
   ...
   :card_description: Learn how to use <code>torchffmpeg.datasets</code> module.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/audio_datasets_tutorial.png
   :link: tutorials/audio_datasets_tutorial.html
   :tags: Dataset

.. customcarditem::
   :header: AM inference with Wav2Vec2
   :card_description: Learn how to perform acoustic model inference with Wav2Vec2 (<code>torchffmpeg.pipelines.Wav2Vec2ASRBundle</code>).
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/speech_recognition_pipeline_tutorial.png
   :link: tutorials/speech_recognition_pipeline_tutorial.html
   :tags: ASR,wav2vec2

.. customcarditem::
   :header: LM inference with CTC Beam Seach Decoder
   :card_description: Learn how to perform ASR beam search decoding with lexicon and language model, using <code>torchffmpeg.models.decoder.ctc_decoder</code>.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/asr_inference_with_ctc_decoder_tutorial.png
...
.. customcarditem::
   ...
   :card_description: Learn how to perform online ASR with Emformer RNN-T (<code>torchffmpeg.pipelines.RNNTBundle</code>) and <code>torchffmpeg.io.StreamReader</code>.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/online_asr_tutorial.gif
...
.. customcarditem::
   ...
   :card_description: Learn how to transcribe speech fomr microphone with Emformer RNN-T (<code>torchffmpeg.pipelines.RNNTBundle</code>) and <code>torchffmpeg.io.StreamReader</code>.
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/device_asr.png
   :link: tutorials/device_asr.html
   :tags: Pipelines,ASR,RNNT,StreamReader

.. customcarditem::
   :header: Forced Alignment with Wav2Vec2
   :card_description: Learn how to align text to speech with Wav2Vec 2 (<code>torchffmpeg.pipelines.Wav2Vec2ASRBundle</code>).
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/forced_alignment_tutorial.png
...
.. customcarditem::
   ...
   :card_description: Learn how to generate speech from text with Tacotron2 (<code>torchffmpeg.pipelines.Tacotron2TTSBundle</code>).
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/tacotron2_pipeline_tutorial.png
...
.. customcarditem::
   ...
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/mvdr_tutorial.png
   :link: tutorials/mvdr_tutorial.html
   :tags: Pipelines,Speech-Enhancement

.. customcarditem::
   :header: Music Source Separation with Hybrid Demucs
   :card_description: Learn how to perform music source separation with pre-trained Hybrid Demucs (<code>torchffmpeg.pipelines.SourceSeparationBundle</code>).
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/hybrid_demucs_tutorial.png
...
.. customcarditem::
   ...
   :card_description: Learn how to estimate subjective and objective metrics with pre-trained TorchAudio-SQUIM models (<code>torchffmpeg.pipelines.SQUIMObjective</code>).
   :image: https://download.pytorch.org/torchffmpeg/tutorial-assets/thumbnails/squim_tutorial.png
...
If you find torchffmpeg useful, please cite the following paper:
