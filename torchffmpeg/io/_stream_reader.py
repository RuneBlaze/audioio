...
class StreamReader:
    ...
    def __init__(
        ...
        torch._C._log_api_usage_once("torchffmpeg.io.StreamReader")
        if isinstance(src, str):
            self._be = torch.classes.torchffmpeg.ffmpeg_StreamReader(src, format, option)
        elif isinstance(src, torch.Tensor):
            self._be = torch.classes.torchffmpeg.ffmpeg_StreamReaderTensor(src, format, option, buffer_size)
