...
@dataclass
class SourceStream:
    """The metadata of a source stream, returned by :meth:`~torchffmpeg.io.StreamReader.get_src_stream_info`.
...
class SourceAudioStream(SourceStream):
    """The metadata of an audio source stream, returned by :meth:`~torchffmpeg.io.StreamReader.get_src_stream_info`.
...
class SourceVideoStream(SourceStream):
    """The metadata of a video source stream, returned by :meth:`~torchffmpeg.io.StreamReader.get_src_stream_info`.
...
class OutputStream:
    ...
    returned by :meth:`~torchffmpeg.io.StreamReader.get_out_stream_info`.
    """
...
class OutputAudioStream(OutputStream):
    ...
    :meth:`~torchffmpeg.io.StreamReader.add_audio_stream` or
    :meth:`~torchffmpeg.io.StreamReader.add_basic_audio_stream`.
...
class OutputVideoStream(OutputStream):
    ...
    :meth:`~torchffmpeg.io.StreamReader.add_video_stream` or
    :meth:`~torchffmpeg.io.StreamReader.add_basic_video_stream`.
...
_decoder = """The name of the decoder to be used.
                ...
                :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_audio_decoders` for audio, and
                :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_video_decoders` for video.
...
@torchffmpeg._extension.fail_if_no_ffmpeg
class StreamReader:
    ...
    Args:
        ...
        format (str or None, optional):
            ...
            .. note::
               ...
               Please use :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_demuxers` to list the
               ...
               Please use :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_input_devices` to list
    ...
    def __init__(
        ...
        if isinstance(src, str):
            self._be = torchffmpeg.lib._torchffmpeg_ffmpeg.StreamReader(src, format, option)
        elif hasattr(src, "read"):
            self._be = torchffmpeg.lib._torchffmpeg_ffmpeg.StreamReaderFileObj(src, format, option, buffer_size)
        else:
    ...
    def get_src_stream_info(self, i: int) -> InputStreamTypes:
        ...
        Returns:
            InputStreamTypes:
                ...
                :class:`~torchffmpeg.io._stream_reader.SourceAudioStream` is returned.
                If it is video type, then
                :class:`~torchffmpeg.io._stream_reader.SourceVideoStream` is returned.
                Otherwise :class:`~torchffmpeg.io._stream_reader.SourceStream` class is returned.
        """
    ...
    def get_out_stream_info(self, i: int) -> OutputStreamTypes:
        ...
        Returns:
            OutputStreamTypes
                ...
                :class:`~torchffmpeg.io._stream_reader.OutputAudioStream` is returned.
                If it is video type, then
                :class:`~torchffmpeg.io._stream_reader.OutputVideoStream` is returned.
        """
