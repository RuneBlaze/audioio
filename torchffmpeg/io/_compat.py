...
def info_audio(
    ...
    i = torch.ops.torchffmpeg.compat_info(src, format)
...
def info_audio_fileobj(
    ...
    s = torchffmpeg.lib._torchffmpeg_ffmpeg.StreamReaderFileObj(src, format, None, buffer_size)
...
def _load_audio_fileobj(
    s: torchffmpeg.lib._torchffmpeg_ffmpeg.StreamReaderFileObj,
...
def load_audio(
    ...
    return torch.ops.torchffmpeg.compat_load(src, format, filter, channels_first)
