...
if torchffmpeg._extension._FFMPEG_INITIALIZED:
    ConfigBase = torchffmpeg.lib._torchffmpeg_ffmpeg.CodecConfig
else:
    ConfigBase = object
...
_encoder = """The name of the encoder to be used.
                ...
                :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_audio_encoders` for audio, and
                :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_video_encoders` for video.
...
class StreamWriter:
    ...
    Args:
        ...
        format (str or None, optional):
            ...
            .. note::
               ...
               Please use :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_muxers` to list the
               ...
               Please use :py:func:`~torchffmpeg.utils.ffmpeg_utils.get_output_devices` to list
    ...
    def __init__(
        ...
        if isinstance(dst, str):
            self._s = torchffmpeg.lib._torchffmpeg_ffmpeg.StreamWriter(dst, format)
        elif hasattr(dst, "write"):
            self._s = torchffmpeg.lib._torchffmpeg_ffmpeg.StreamWriterFileObj(dst, format, buffer_size)
        else:
    ...
    def open(self, option: Optional[Dict[str, str]] = None) -> "StreamWriter":
        ...
        Example - Muxer option
            ...
            >>> s.add_audio_stream(...)
            >>> s.set_metadata({"artist": "torchffmpeg contributors"})
