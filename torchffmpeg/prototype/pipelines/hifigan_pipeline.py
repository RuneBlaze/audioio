...
from torchffmpeg.prototype.models.hifi_gan import hifigan_vocoder, HiFiGANVocoder
...
class HiFiGANVocoderBundle:
    ...
    :py:class:`~torchffmpeg.prototype.models.HiFiGANVocoder`.
    ...
    Example: Transform synthetic mel spectrogram to audio.
        ...
        >>> from torchffmpeg.prototype.pipelines import HIFIGAN_VOCODER_V3_LJSPEECH as bundle
        >>>
        >>> # Load the HiFiGAN bundle
        >>> vocoder = bundle.get_vocoder()
        Downloading: "https://download.pytorch.org/torchffmpeg/models/hifigan_vocoder_v3_ljspeech.pth"
        ...
        >>> torchffmpeg.save('sample.wav', waveform, bundle.sample_rate)

    Example: Usage together with Tacotron2, text to audio.
        >>> import torch
        >>> import torchffmpeg
        >>> # Since HiFiGAN bundle is in prototypes, it needs to be exported explicitly
        >>> from torchffmpeg.prototype.pipelines import HIFIGAN_VOCODER_V3_LJSPEECH as bundle_hifigan
        >>>
        >>> # Load Tacotron2 bundle
        >>> bundle_tactron2 = torchffmpeg.pipelines.TACOTRON2_WAVERNN_CHAR_LJSPEECH
        ...
        >>> torchffmpeg.save('sample.wav', waveform, bundle_hifigan.sample_rate)
    """  # noqa: E501
    ...
    def get_vocoder(self, *, dl_kwargs=None) -> HiFiGANVocoder:
        ...
        Returns:
            Variation of :py:class:`~torchffmpeg.prototype.models.HiFiGANVocoder`.
        """
...
class _HiFiGANMelSpectrogram(torch.nn.Module):
    ...
    This class wraps around :py:class:`torchffmpeg.transforms.MelSpectrogram`, but performs extra steps to achive
...
HIFIGAN_VOCODER_V3_LJSPEECH.__doc__ = """HiFiGAN Vocoder pipeline, trained on *The LJ Speech Dataset*
    ...
    :py:class:`torchffmpeg.transforms.MelSpectrogram`. We reimplemented this transform as
    ...
    :py:func:`torchffmpeg.prototype.models.hifigan_vocoder`. The weights are converted from the ones published
