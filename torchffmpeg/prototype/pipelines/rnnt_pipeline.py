...
from torchffmpeg.models import emformer_rnnt_base
from torchffmpeg.pipelines import RNNTBundle
...
EMFORMER_RNNT_BASE_MUSTC.__doc__ = """Pre-trained Emformer-RNNT-based ASR pipeline capable of performing both streaming and non-streaming inference.
    The underlying model is constructed by :py:func:`torchffmpeg.models.emformer_rnnt_base` and utilizes weights
    ...
    Please refer to :py:class:`torchffmpeg.pipelines.RNNTBundle` for usage instructions.
    """
