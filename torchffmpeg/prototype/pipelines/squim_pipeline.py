...
from torchffmpeg.prototype.models import squim_objective_base, squim_subjective_base, SquimObjective, SquimSubjective


@dataclass
class SquimObjectiveBundle:
    """Data class that bundles associated information to use pretrained
    :py:class:`~torchffmpeg.prototype.models.SquimObjective` model.
    ...
    Example: Estimate the objective metric scores for the input waveform.
        ...
        >>> from torchffmpeg.prototype.pipelines import SQUIM_OBJECTIVE as bundle
        >>>
        >>> # Load the SquimObjective bundle
        >>> model = bundle.get_model()
        Downloading: "https://download.pytorch.org/torchffmpeg/models/squim_objective_dns2020.pth"
    ...
    def _get_state_dict(self, dl_kwargs):
        url = f"https://download.pytorch.org/torchffmpeg/models/{self._path}"
    ...
    def get_model(self, *, dl_kwargs=None) -> SquimObjective:
        ...
        Returns:
            Variation of :py:class:`~torchffmpeg.prototype.models.SquimObjective`.
        """
...
SQUIM_OBJECTIVE.__doc__ = """SquimObjective pipeline trained using approach described in
    :cite:`kumar2023torchffmpeg` on the *DNS 2020 Dataset* :cite:`reddy2020interspeech`.

    The underlying model is constructed by :py:func:`torchffmpeg.prototype.models.squim_objective_base`.
...
class SquimSubjectiveBundle:
    """Data class that bundles associated information to use pretrained
    :py:class:`~torchffmpeg.prototype.models.SquimSubjective` model.
    ...
    Example: Estimate the subjective metric scores for the input waveform.
        ...
        >>> from torchffmpeg.prototype.pipelines import SQUIM_SUBJECTIVE as bundle
        >>>
        >>> # Load the SquimSubjective bundle
        >>> model = bundle.get_model()
        Downloading: "https://download.pytorch.org/torchffmpeg/models/squim_subjective_bvcc_daps.pth"
        ...
        >>> reference = torchffmpeg.functional.resample(reference, sample_rate, bundle.sample_rate)
        >>>
...
SQUIM_SUBJECTIVE.__doc__ = """SquimSubjective pipeline trained
    as described in :cite:`manocha2022speech` and :cite:`kumar2023torchffmpeg`
    on the *BVCC* :cite:`cooper2021voices` and *DAPS* :cite:`mysore2014can` datasets.

    The underlying model is constructed by :py:func:`torchffmpeg.prototype.models.squim_subjective_base`.
