...
import torch
from torchffmpeg.models import Wav2Vec2Model
from torchffmpeg.models.emformer import Emformer
from torchffmpeg.models.rnnt import _TimeReduction
...
class EmformerEncoder(torch.nn.Module):
    ...
    Args:
        emformer (torch.nn.Module):
            :py:class:`torchffmpeg.models.Emformer` module that consists of a list of emformer layers.
...
def emformer_hubert_model(
    ...
    Returns:
        Wav2Vec2Model:
            The resulting :py:class:`torchffmpeg.models.Wav2Vec2Model` model
            with a :py:class:`torchffmpeg.models.Emformer` encoder.
    """
