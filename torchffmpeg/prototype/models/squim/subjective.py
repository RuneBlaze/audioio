...
def squim_subjective_model(
    ...
    """Build a custome :class:`torchffmpeg.prototype.models.SquimSubjective` model.
    ...
    """
    ssl_model = getattr(torchffmpeg.models, ssl_type)()
...
def squim_subjective_base() -> SquimSubjective:
    """Build :class:`torchffmpeg.prototype.models.SquimSubjective` model with default arguments."""
