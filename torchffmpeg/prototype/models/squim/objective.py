...
def squim_objective_model(
    ...
    """Build a custome :class:`torchffmpeg.prototype.models.SquimObjective` model.
...
def squim_objective_base() -> SquimObjective:
    """Build :class:`torchffmpeg.prototype.models.SquimObjective` model with default arguments."""
