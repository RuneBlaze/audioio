...
import torch
from torchffmpeg.prototype.functional import barkscale_fbanks
from torchffmpeg.transforms import Spectrogram
...
class BarkScale(torch.nn.Module):
    ...
    See also:
        :py:func:`torchffmpeg.prototype.functional.barkscale_fbanks` - The function used to
...
class BarkSpectrogram(torch.nn.Module):
    ...
    and :py:func:`torchffmpeg.transforms.BarkScale`.
