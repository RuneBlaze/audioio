...
from torchffmpeg.functional import fftconvolve
...
def oscillator_bank(
    ...
    Note:
        ...
        .. image:: https://download.pytorch.org/torchffmpeg/doc-assets/oscillator_precision.png
    ...
    # In torchffmpeg, a simple way to work around is to use float64.
...
def adsr_envelope(
    ...
    *,
    ...
    Example
        .. image:: https://download.pytorch.org/torchffmpeg/doc-assets/adsr_examples.png
...
def filter_waveform(waveform: torch.Tensor, kernels: torch.Tensor, delay_compensation: int = -1):
    ...
    The following figure illustrates this.
        ...
        .. image:: https://download.pytorch.org/torchffmpeg/doc-assets/filter_waveform.png
