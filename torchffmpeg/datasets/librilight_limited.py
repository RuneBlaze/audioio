...
from torchffmpeg.datasets.librispeech import _get_librispeech_metadata
from torchffmpeg.datasets.utils import _extract_tar
...
class LibriLightLimited(Dataset):
    ...
    def __getitem__(self, n: int) -> Tuple[Tensor, int, str, int, int, int]:
        ...
        waveform, _ = torchffmpeg.load(os.path.join(self._path, metadata[0]))
