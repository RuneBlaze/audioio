...
class RNNT(torch.nn.Module):
    ...
    See Also:
        :class:`torchffmpeg.pipelines.RNNTBundle`: ASR pipeline with pre-trained models.
...
def emformer_rnnt_model(
    *,
    ...
    r"""Builds Emformer-based :class:`~torchffmpeg.models.RNNT`.
...
def emformer_rnnt_base(num_symbols: int) -> RNNT:
    r"""Builds basic version of Emformer-based :class:`~torchffmpeg.models.RNNT`.
