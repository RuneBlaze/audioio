...
class Emformer(_EmformerImpl):
    ...
    *Emformer: Efficient Memory Transformer Based Acoustic Model for Low Latency Streaming Speech Recognition*
    ...
    See Also:
        * :func:`~torchffmpeg.models.emformer_rnnt_model`,
          :func:`~torchffmpeg.models.emformer_rnnt_base`: factory functions.
        * :class:`torchffmpeg.pipelines.RNNTBundle`: ASR pipelines with pretrained model.
