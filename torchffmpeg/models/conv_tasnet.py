...
class ConvTasNet(torch.nn.Module):
    ...
    *Conv-TasNet: Surpassing Ideal Time–Frequency Magnitude Masking for Speech Separation*
    ...
    See Also:
        * :class:`torchffmpeg.pipelines.SourceSeparationBundle`: Source separation pipeline with pre-trained models.
...
def conv_tasnet_base(num_sources: int = 2) -> ConvTasNet:
    r"""Builds non-causal version of :class:`~torchffmpeg.models.ConvTasNet`.
