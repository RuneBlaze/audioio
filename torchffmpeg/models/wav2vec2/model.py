...
class Wav2Vec2Model(Module):
    ...
    See Also:
        * :class:`torchffmpeg.pipelines.Wav2Vec2Bundle`: Pretrained models (without fine-tuning)
        * :class:`torchffmpeg.pipelines.Wav2Vec2ASRBundle`: ASR pipelines with pretrained models.
...
def wav2vec2_model(
    ...
    """Builds custom :class:`~torchffmpeg.models.Wav2Vec2Model`.
...
def wav2vec2_base(
    ...
    """Builds "base" :class:`~torchffmpeg.models.Wav2Vec2Model` from *wav2vec 2.0* :cite:`baevski2020wav2vec`
...
def wav2vec2_large(
    ...
    """Builds "large" :class:`~torchffmpeg.models.Wav2Vec2Model` from *wav2vec 2.0* :cite:`baevski2020wav2vec`
...
def wav2vec2_large_lv60k(
    ...
    """Builds "large lv-60k" :class:`~torchffmpeg.models.Wav2Vec2Model` from *wav2vec 2.0* :cite:`baevski2020wav2vec`
...
def hubert_base(
    ...
    """Builds "base" :class:`HuBERT <torchffmpeg.models.Wav2Vec2Model>` from *HuBERT* :cite:`hsu2021hubert`
...
def hubert_large(
    ...
    """Builds "large" :class:`HuBERT <torchffmpeg.models.Wav2Vec2Model>` from *HuBERT* :cite:`hsu2021hubert`
...
def hubert_xlarge(
    ...
    """Builds "extra large" :class:`HuBERT <torchffmpeg.models.Wav2Vec2Model>` from *HuBERT* :cite:`hsu2021hubert`
...
def wavlm_model(
    ...
    :class:`~torchffmpeg.models.Wav2Vec2Model`. Most of the arguments have the same meaning
    as in :py:func:`~torchffmpeg.models.wav2vec2_model` so please refer there for documentation.

    Args:
        extractor_mode (str): Operation mode of feature extractor.
            See :py:func:`~torchffmpeg.models.wav2vec2_model`.
...
def wavlm_base(
    ...
    :class:`~torchffmpeg.models.Wav2Vec2Model`.
