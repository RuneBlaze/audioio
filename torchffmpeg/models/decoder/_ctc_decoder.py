...
# alongside torchffmpeg.
if torchffmpeg._internal.module_utils.is_module_available("flashlight"):
    ...
    torchffmpeg._extension._load_lib("libflashlight-text")
    from torchffmpeg.lib.flashlight_lib_text_decoder import (
        CriterionType as _CriterionType,
        KenLM as _KenLM,
        LexiconDecoder as _LexiconDecoder,
        LexiconDecoderOptions as _LexiconDecoderOptions,
    ...
    from torchffmpeg.lib.flashlight_lib_text_dictionary import (
        create_word_dict as _create_word_dict,
        Dictionary as _Dictionary,
        load_words as _load_words,
    )
...
class CTCHypothesis(NamedTuple):
    ...
    Note:
        ...
        :func:`~torchffmpeg.models.decoder.CTCDecoder.idxs_to_tokens` instead.
    """
