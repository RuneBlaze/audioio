...
def read_vec_int_ark(file_or_fd: Any) -> Iterable[Tuple[str, Tensor]]:
    ...
    Example
        ...
        >>> d = { u:d for u,d in torchffmpeg.kaldi_io.read_vec_int_ark(file) }
    """
...
def read_vec_flt_scp(file_or_fd: Any) -> Iterable[Tuple[str, Tensor]]:
    ...
    Example
        ...
        >>> # d = { u:d for u,d in torchffmpeg.kaldi_io.read_vec_flt_scp(file) }
    """
...
def read_vec_flt_ark(file_or_fd: Any) -> Iterable[Tuple[str, Tensor]]:
    ...
    Example
        >>> # read ark to a 'dictionary'
        >>> d = { u:d for u,d in torchffmpeg.kaldi_io.read_vec_flt_ark(file) }
    """
...
def read_mat_scp(file_or_fd: Any) -> Iterable[Tuple[str, Tensor]]:
    ...
    Example
        >>> # read scp to a 'dictionary'
        >>> d = { u:d for u,d in torchffmpeg.kaldi_io.read_mat_scp(file) }
    """
...
def read_mat_ark(file_or_fd: Any) -> Iterable[Tuple[str, Tensor]]:
    ...
    Example
        >>> # read ark to a 'dictionary'
        >>> d = { u:d for u,d in torchffmpeg.kaldi_io.read_mat_ark(file) }
    """
