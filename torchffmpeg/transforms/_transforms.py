...
from torchffmpeg import functional as F
from torchffmpeg.functional.functional import (
...
class Spectrogram(torch.nn.Module):
    ...
    Example
        >>> waveform, sample_rate = torchffmpeg.load("test.wav", normalize=True)
        >>> transform = torchffmpeg.transforms.Spectrogram(n_fft=800)
    ...
    def __init__(
        ...
        torch._C._log_api_usage_once("torchffmpeg.transforms.Spectrogram")
        self.n_fft = n_fft
        ...
        if return_complex is not None:
            warnings.warn(
                ...
                "`torchffmpeg.transforms.Spectrogram(power=None)` always returns a tensor with "
...
class MelScale(torch.nn.Module):
    ...
    See also:
        :py:func:`torchffmpeg.functional.melscale_fbanks` - The function used to
...
class MelSpectrogram(torch.nn.Module):
    ...
    This is a composition of :py:func:`torchffmpeg.transforms.Spectrogram` and
    and :py:func:`torchffmpeg.transforms.MelScale`.
    ...
    def __init__(
        ...
        torch._C._log_api_usage_once("torchffmpeg.transforms.MelSpectrogram")
...
class LFCC(torch.nn.Module):
    ...
    See also:
        :py:func:`torchffmpeg.functional.linear_fbanks` - The function used to
        generate the filter banks.
    """
...
class MuLawEncoding(torch.nn.Module):
    ...
    Example
       >>> waveform, sample_rate = torchffmpeg.load("test.wav", normalize=True)
       >>> transform = torchffmpeg.transforms.MuLawEncoding(quantization_channels=512)
...
class MuLawDecoding(torch.nn.Module):
    ...
    Example
        >>> waveform, sample_rate = torchffmpeg.load("test.wav", normalize=True)
        >>> transform = torchffmpeg.transforms.MuLawDecoding(quantization_channels=512)
        >>> mulawtrans = transform(waveform)
    """
    __constants__ = ["quantization_channels"]
...
class ComputeDeltas(torch.nn.Module):
    ...
    See `torchffmpeg.functional.compute_deltas` for more details.
...
class TimeStretch(torch.nn.Module):
    ...
    Example
        >>> spectrogram = torchffmpeg.transforms.Spectrogram()
        >>> stretch = torchffmpeg.transforms.TimeStretch()
        >>>
        >>> original = spectrogram(waveform)
        >>> streched_1_2 = stretch(original, 1.2)
        >>> streched_0_9 = stretch(original, 0.9)

        .. image:: https://download.pytorch.org/torchffmpeg/doc-assets/specaugment_time_stretch_1.png
           :width: 600
           :alt: Spectrogram streched by 1.2

        .. image:: https://download.pytorch.org/torchffmpeg/doc-assets/specaugment_time_stretch_2.png
           :width: 600
           :alt: The original spectrogram

        .. image:: https://download.pytorch.org/torchffmpeg/doc-assets/specaugment_time_stretch_3.png
           :width: 600
...
class FrequencyMasking(_AxisMasking):
    ...
    Example
        >>> spectrogram = torchffmpeg.transforms.Spectrogram()
        >>> masking = torchffmpeg.transforms.FrequencyMasking(freq_mask_param=80)
        >>>
        >>> original = spectrogram(waveform)
        >>> masked = masking(original)

        .. image::  https://download.pytorch.org/torchffmpeg/doc-assets/specaugment_freq_masking1.png
           :alt: The original spectrogram

        .. image::  https://download.pytorch.org/torchffmpeg/doc-assets/specaugment_freq_masking2.png
...
class TimeMasking(_AxisMasking):
    ...
    Example
        >>> spectrogram = torchffmpeg.transforms.Spectrogram()
        >>> masking = torchffmpeg.transforms.TimeMasking(time_mask_param=80)
        >>>
        >>> original = spectrogram(waveform)
        >>> masked = masking(original)

        .. image::  https://download.pytorch.org/torchffmpeg/doc-assets/specaugment_time_masking1.png
           :alt: The original spectrogram

        .. image::  https://download.pytorch.org/torchffmpeg/doc-assets/specaugment_time_masking2.png
...
class AddNoise(torch.nn.Module):
    ...
    See :meth:`torchffmpeg.functional.add_noise` for more details.
...
class Preemphasis(torch.nn.Module):
    ...
    See :meth:`torchffmpeg.functional.preemphasis` for more details.
...
class Deemphasis(torch.nn.Module):
    ...
    See :meth:`torchffmpeg.functional.deemphasis` for more details.
