...
def get_versions() -> Dict[str, Tuple[int]]:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_versions()
...
def get_log_level() -> int:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_log_level()
...
def set_log_level(level: int):
    ...
    """
    torch.ops.torchffmpeg.ffmpeg_set_log_level(level)
...
def get_demuxers() -> Dict[str, str]:
    ...
    Example
        ...
        ... ac3: raw AC-3
    """
    return torch.ops.torchffmpeg.ffmpeg_get_demuxers()
...
def get_muxers() -> Dict[str, str]:
    ...
    Example
        ...
        ... aiff: Audio IFF
    """
    return torch.ops.torchffmpeg.ffmpeg_get_muxers()
...
def get_audio_decoders() -> Dict[str, str]:
    ...
    Example
        ...
        ... aiff: Audio IFF
    """
    return torch.ops.torchffmpeg.ffmpeg_get_audio_decoders()
...
def get_audio_encoders() -> Dict[str, str]:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_audio_encoders()
...
def get_video_decoders() -> Dict[str, str]:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_video_decoders()
...
def get_video_encoders() -> Dict[str, str]:
    ...
    Example
        ...
        ... asv2: ASUS V2
    """
    return torch.ops.torchffmpeg.ffmpeg_get_video_encoders()
...
def get_input_devices() -> Dict[str, str]:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_input_devices()
...
def get_output_devices() -> Dict[str, str]:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_output_devices()
...
def get_input_protocols() -> List[str]:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_input_protocols()
...
def get_output_protocols() -> List[str]:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_output_protocols()
...
def get_build_config() -> str:
    ...
    """
    return torch.ops.torchffmpeg.ffmpeg_get_build_config()
