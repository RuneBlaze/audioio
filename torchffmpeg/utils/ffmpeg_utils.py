...
It affects functionalities in :py:mod:`torchffmpeg.io` (and indirectly :py:func:`torchffmpeg.load`).
"""
...
def get_versions() -> Dict[str, Tuple[int]]:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_versions()
...
def get_log_level() -> int:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_log_level()
...
def set_log_level(level: int):
    ...
    """
    torchffmpeg.lib._torchffmpeg_ffmpeg.set_log_level(level)
...
def get_demuxers() -> Dict[str, str]:
    ...
    Example
        ...
        ... ac3: raw AC-3
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_demuxers()
...
def get_muxers() -> Dict[str, str]:
    ...
    Example
        ...
        ... aiff: Audio IFF
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_muxers()
...
def get_audio_decoders() -> Dict[str, str]:
    ...
    Example
        ...
        ... aiff: Audio IFF
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_audio_decoders()
...
def get_audio_encoders() -> Dict[str, str]:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_audio_encoders()
...
def get_video_decoders() -> Dict[str, str]:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_video_decoders()
...
def get_video_encoders() -> Dict[str, str]:
    ...
    Example
        ...
        ... asv2: ASUS V2
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_video_encoders()
...
def get_input_devices() -> Dict[str, str]:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_input_devices()
...
def get_output_devices() -> Dict[str, str]:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_output_devices()
...
def get_input_protocols() -> List[str]:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_input_protocols()
...
def get_output_protocols() -> List[str]:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_output_protocols()
...
def get_build_config() -> str:
    ...
    """
    return torchffmpeg.lib._torchffmpeg_ffmpeg.get_build_config()


@torchffmpeg._extension.fail_if_no_ffmpeg
def clear_cuda_context_cache():
    """Clear the CUDA context used by CUDA Hardware accelerated video decoding"""
    torchffmpeg.lib._torchffmpeg_ffmpeg.clear_cuda_context_cache()
