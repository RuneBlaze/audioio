...
from torchffmpeg.models import conv_tasnet_base, hdemucs_high
...
class SourceSeparationBundle:
    ...
    Example
        >>> import torchffmpeg
        >>> from torchffmpeg.pipelines import CONVTASNET_BASE_LIBRI2MIX
        >>> import torch
        >>>
        ...
        >>> dataset = torchffmpeg.datasets.LibriMix("/home/datasets/", subset="test")
        >>>
    ...
    def get_model(self) -> torch.nn.Module:
        ...
        path = torchffmpeg.utils.download_asset(self._model_path)
...
The source separation model is constructed by :func:`~torchffmpeg.models.conv_tasnet_base`
...
The model is constructed by :func:`~torchffmpeg.models.hdemucs_high`.
