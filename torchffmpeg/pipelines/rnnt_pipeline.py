...
import torch
import torchffmpeg
from torchffmpeg._internal import module_utils
from torchffmpeg.models import emformer_rnnt_base, RNNT, RNNTBeamSearch
...
class RNNTBundle:
    ...
    e.g. :data:`torchffmpeg.pipelines.EMFORMER_RNNT_BASE_LIBRISPEECH`.

    Example
        >>> import torchffmpeg
        >>> from torchffmpeg.pipelines import EMFORMER_RNNT_BASE_LIBRISPEECH
        >>> import torch
        >>>
        ...
        Downloading: "https://download.pytorch.org/torchffmpeg/models/emformer_rnnt_base_librispeech.pt"
        ...
        >>> dataset = torchffmpeg.datasets.LIBRISPEECH("/home/librispeech", url="test-clean")
    ...
    def _get_model(self) -> RNNT:
        ...
        path = torchffmpeg.utils.download_asset(self._rnnt_path)
    ...
    def get_feature_extractor(self) -> FeatureExtractor:
        ...
        Returns:
            FeatureExtractor
        """
        local_path = torchffmpeg.utils.download_asset(self._global_stats_path)
    ...
    def get_token_processor(self) -> TokenProcessor:
        ...
        Returns:
            TokenProcessor
        """
        local_path = torchffmpeg.utils.download_asset(self._sp_model_path)
...
The underlying model is constructed by :py:func:`torchffmpeg.models.emformer_rnnt_base`
