...
class Tacotron2TTSBundle(ABC):
    ...
    Example - Character-based TTS pipeline with Tacotron2 and WaveRNN
        ...
        >>>
        >>> text = "Hello, T T S !"
        >>> bundle = torchffmpeg.pipelines.TACOTRON2_WAVERNN_CHAR_LJSPEECH
        >>>
        ...
        >>>
        >>> torchffmpeg.save('hello-tts.wav', waveforms, vocoder.sample_rate)
    ...
    # `torchffmpeg.pipelines`, but still listed in documentation.
    ...
    class TextProcessor(_TextProcessor):
        ...
        See :func:`torchffmpeg.pipelines.Tacotron2TTSBundle.get_text_processor` for the usage.
        """

    class Vocoder(_Vocoder):
        """Interface of the vocoder part of Tacotron2TTS pipeline

        See :func:`torchffmpeg.pipelines.Tacotron2TTSBundle.get_vocoder` for the usage.
        """
