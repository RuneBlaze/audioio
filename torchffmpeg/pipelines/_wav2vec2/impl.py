...
from torchffmpeg.models import wav2vec2_model, Wav2Vec2Model, wavlm_model
...
class _Wav2Vec2Model(Module):
    """Wrapper class for :py:class:`~torchffmpeg.models.Wav2Vec2Model`.
...
class Wav2Vec2Bundle:
    """Data class that bundles associated information to use pretrained :py:class:`~torchffmpeg.models.Wav2Vec2Model`.
    ...
    Example - Feature Extraction
        >>> import torchffmpeg
        >>>
        >>> bundle = torchffmpeg.pipelines.HUBERT_BASE
        >>>
    ...
    def get_model(self, *, dl_kwargs=None) -> Module:
        ...
        Returns:
            Variation of :py:class:`~torchffmpeg.models.Wav2Vec2Model`.

            For the models listed below, an additional layer normalization is performed on the input.

            For all other models, a :py:class:`~torchffmpeg.models.Wav2Vec2Model` instance is returned.
...
class Wav2Vec2ASRBundle(Wav2Vec2Bundle):
    ...
    :py:class:`~torchffmpeg.models.Wav2Vec2Model`.
    ...
    def get_labels(
        ...
        *,
        ...
        Example
            >>> import torchffmpeg
            >>> torchffmpeg.models.HUBERT_ASR_LARGE.get_labels()
            ('-', '|', 'E', 'T', 'A', 'O', 'N', 'I', 'H', 'S', 'R', 'D', 'L', 'U', 'M', 'W', 'C', 'F', 'G', 'Y', 'P', 'B', 'V', 'K', "'", 'X', 'J', 'Q', 'Z')
        """  # noqa: E501
...
Please refer to :py:class:`torchffmpeg.pipelines.Wav2Vec2Bundle` for the usage.
"""  # noqa: E501
...
Please refer to :py:class:`torchffmpeg.pipelines.Wav2Vec2ASRBundle` for the usage.
"""  # noqa: E501
...
Please refer to :py:class:`torchffmpeg.pipelines.Wav2Vec2Bundle` for usage details.
"""  # noqa: E501
