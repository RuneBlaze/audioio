...
from torchffmpeg._extension import _IS_TORCHFFMPEG_EXT_AVAILABLE
...
if _IS_TORCHFFMPEG_EXT_AVAILABLE:
    _lfilter_core_cpu_loop = torch.ops.torchffmpeg._lfilter_core_loop
else:
...
if _IS_TORCHFFMPEG_EXT_AVAILABLE:
    _lfilter = torch.ops.torchffmpeg._lfilter
else:
...
if _IS_TORCHFFMPEG_EXT_AVAILABLE:
    _overdrive_core_loop_cpu = torch.ops.torchffmpeg._overdrive_core_loop
else:
