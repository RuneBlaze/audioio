...
#include <sox.h>
#include <torchffmpeg/csrc/sox/types.h>
...
TORCH_LIBRARY_FRAGMENT(torchffmpeg, m) {
  m.def("torchffmpeg::sox_utils_set_seed", &torchffmpeg::sox_utils::set_seed);
  m.def(
      "torchffmpeg::sox_utils_set_verbosity",
      &torchffmpeg::sox_utils::set_verbosity);
  m.def(
      "torchffmpeg::sox_utils_set_use_threads",
      &torchffmpeg::sox_utils::set_use_threads);
  m.def(
      "torchffmpeg::sox_utils_set_buffer_size",
      &torchffmpeg::sox_utils::set_buffer_size);
  m.def(
      "torchffmpeg::sox_utils_list_effects",
      &torchffmpeg::sox_utils::list_effects);
  m.def(
      "torchffmpeg::sox_utils_list_read_formats",
      &torchffmpeg::sox_utils::list_read_formats);
  m.def(
      "torchffmpeg::sox_utils_list_write_formats",
      &torchffmpeg::sox_utils::list_write_formats);
  m.def(
      "torchffmpeg::sox_utils_get_buffer_size",
      &torchffmpeg::sox_utils::get_buffer_size);
}
