...
auto apply_effects_tensor(
  ...
  torchffmpeg::sox_effects_chain::SoxEffectsChain chain(
...
TORCH_LIBRARY_FRAGMENT(torchffmpeg, m) {
  m.def(
      "torchffmpeg::sox_effects_initialize_sox_effects",
      &torchffmpeg::sox_effects::initialize_sox_effects);
  m.def(
      "torchffmpeg::sox_effects_shutdown_sox_effects",
      &torchffmpeg::sox_effects::shutdown_sox_effects);
  m.def(
      "torchffmpeg::sox_effects_apply_effects_tensor",
      &torchffmpeg::sox_effects::apply_effects_tensor);
  m.def(
      "torchffmpeg::sox_effects_apply_effects_file",
      &torchffmpeg::sox_effects::apply_effects_file);
}
