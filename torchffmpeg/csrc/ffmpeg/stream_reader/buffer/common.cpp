#include <torchffmpeg/csrc/ffmpeg/stream_reader/buffer/common.h>
#include <stdexcept>
#include <vector>
...
torch::Tensor convert_audio(AVFrame* pFrame) {
  ...
  // This corresponds to `num_frames` in torchffmpeg's notation.
  // Also torchffmpeg uses `num_samples` as the number of samples
  // across channels.
